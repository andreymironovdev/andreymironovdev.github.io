...
window.scrollReveal = function (t) {
    ...
    return e.prototype = {
        defaults: {
            ...
            var args = t.getAttribute("data-scroll-reveal").split(/[, ]+/);
            var viewportFactorIndex = args.findIndex(v => v == "viewportFactor");
            var viewportFactor = viewportFactorIndex == -1 ? this.options.viewportFactor : args[viewportFactorIndex + 1];
            var e = this.genCSS(t), i = this.styleBank[t.getAttribute("data-scroll-reveal-id")];
            return null != i ? i += ";" : i = "", t.getAttribute("data-scroll-reveal-initialized") || (t.setAttribute("style", i + e.initial), t.setAttribute("data-scroll-reveal-initialized", !0)), this.isElementInViewport(t, viewportFactor) ? t.getAttribute("data-scroll-reveal-complete") ? void 0 : this.isElementInViewport(t, viewportFactor) ? (t.setAttribute("style", i + e.target + e.transition), void (this.options.reset || setTimeout(function () {
            ...
            var r = o.move || this.options.move, n = o.over || this.options.over, s = o.after || this.options.after,
                a = o.easing || this.options.easing, l = o.opacity || this.options.opacity,
            ...
            var o = t.pageYOffset, r = o + this.getViewportH(), n = e.offsetHeight, s = this.getOffset(e).top,
                a = s + n, i = i || 0;
